...
|---|---|---|
| **Main Engine & Loop** | [`main.py`](file:///d:/google%20antigravity/jane_street_trading_system/trading/bot/main.py) | Z-score calculation, trade execution, trailing stop, Friday guard |
| **Kalman Filter** | [`kalman_filter.py`](file:///d:/google%20antigravity/jane_street_trading_system/trading/bot/kalman_filter.py) | Matrix operations, state-space vector updates, covariance matrices |
| **Database Sync** | [`database.py`](file:///d:/google%20antigravity/jane_street_trading_system/trading/bot/database.py) | PostgreSQL persistence, bot_state, daily_metrics, deadlock retries |
| **Risk Safeguards** | [`risk_safeguards.py`](file:///d:/google%20antigravity/jane_street_trading_system/trading/bot/risk_safeguards.py) | Daily drawdown verification, lot size safety checks |
| **News Guard** | [`news_guard.py`](file:///d:/google%20antigravity/jane_street_trading_system/trading/bot/news_guard.py) | High-impact economic news detection & buffer checks |
