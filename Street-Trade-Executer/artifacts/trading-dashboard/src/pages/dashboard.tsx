      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-zinc-500 font-mono text-[10px] uppercase flex items-center gap-2">
            ...
            <span className={cn("px-1.5 py-0.5 rounded-sm text-[10px] font-bold border transition-all duration-300", dashboard.stocksEnabled ? "bg-purple-500/10 text-purple-400 border-purple-500/30 shadow-[0_0_10px_rgba(168,85,247,0.15)]" : "text-zinc-600 border-zinc-800 bg-zinc-900/20 opacity-50")}>Stocks</span>
          </div>
